...
public class NestedBlockDepth {
    ...
    private int nestedBlockDepthValue;

    public NestedBlockDepth(){
        nestedBlockDepthValue =-1;
    }

    public int getNestedBlockDepthValue() {
        return nestedBlockDepthValue;
    }

    public void setNestedBlockDepthValue(int nestedBlockDepthValue) {
        this.nestedBlockDepthValue = nestedBlockDepthValue;
    }

    public void calculateNBD (String code) {
        ...
        OptionalInt maxDepth = allNestedBlocks.parallelStream().mapToInt(block -> {
         ...
         setNestedBlockDepthValue(maxDepth.orElse(1)-1);
